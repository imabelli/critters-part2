...
public abstract class Critter {
	...
	private	static List<Critter> population = new ArrayList<Critter>();	//holds all critters alive or that died in current time step
	private static List<Critter> babies = new ArrayList<Critter>();	//babies formed each time step
